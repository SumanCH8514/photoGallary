...
<body>
    ...
    <div class="category-filter">
        <a href="./admin/upload.php" style="text-decoration: none;"><b>Upload More Photos</b></a>
    ...
    <div class="masonry-gallery">
        <!-- change the admin if uploads folder path changes -->
        <?php
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo '<div class="masonry-item">
                        <img src="' . "admin/" . $row['image_url'] . '" alt="Gallery Image">
